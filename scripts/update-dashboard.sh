#!/bin/bash
# Woker Dashboard Update
# Spusť: bash update-dashboard.sh
set -e
echo "🚀 Updating dashboard..."

cat > app/dashboard/page.tsx << 'FILEEND'
...
echo ""
echo "Ověření:"
grep "kontakty" app/dashboard/page.tsx && echo "✅ Nový kód je na místě!" || echo "❌ Něco se pokazilo"
echo ""
echo "Teď spusť: npm run dev"
