...
// Extract roky z textu (např. "2019-2024" → "5")
...
export default function EmailSablona() {
  ...
  useEffect(() => {
    ...
    setFormData((f) => {
      ...
      apply('userEmail', profile.email)
      // experience: roky z textu
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <div className="bg-[#111120]/80 backdrop-blur-sm rounded-2xl border border-white/[0.06] p-5 mb-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => handleCopy(german, 'de')}
                className={`text-xs px-3 py-1.5 rounded-lg transition border ${copied === 'de' ? 'bg-[#fb923c]/10 border-[#fb923c]/30 text-[#fb923c]' : 'bg-white/[0.04] border-white/[0.06] text-white/40 hover:text-white'}`}>
          ...
          <div className="bg-[#111120]/80 backdrop-blur-sm rounded-2xl border border-white/[0.06] p-5 mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a href={mailtoHref}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#fb923c] to-[#f97316] text-[#0a0a12] font-bold py-3 rounded-xl no-underline transition hover:shadow-[0_4px_30px_rgba(251,146,60,0.35)] hover:scale-[1.02] active:scale-[0.98] text-sm">
                📧 Výchozí email
              </a>
              <button onClick={() => handleCopy(german, 'full')}
                className={`flex items-center justify-center gap-2 font-bold py-3 rounded-xl transition text-sm border ${copied === 'full' ? 'bg-[#fb923c]/10 border-[#fb923c]/30 text-[#fb923c]' : 'bg-white/[0.04] border-white/[0.08] text-white/60 hover:text-white hover:bg-white/[0.08]'}`}>
            ...
            <div className="bg-[#111120]/80 backdrop-blur-sm rounded-2xl border border-white/[0.06] p-5 mb-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={() => handleCopy(czech, 'cs')}
                  className={`text-xs px-3 py-1.5 rounded-lg transition border ${copied === 'cs' ? 'bg-[#fb923c]/10 border-[#fb923c]/30 text-[#fb923c]' : 'bg-white/[0.04] border-white/[0.06] text-white/40 hover:text-white'}`}>
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="rounded-2xl p-6 mb-6 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #111128 0%, #0d1a2e 40%, #0a1a14 100%)" }}>
          ...
          <div className="relative flex items-center gap-4">
            <Image src="/images/3d/rocket.png" alt="" width={56} height={56} className="drop-shadow-[0_4px_20px_rgba(251,146,60,0.3)]" />
            <div>
