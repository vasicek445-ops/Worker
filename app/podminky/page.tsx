...
export default function Podminky() {
  const sections = [
    { title: "1. \u00DAvodn\u00ED ustanoven\u00ED", text: "Tyto obchodn\u00ED podm\u00EDnky upravuj\u00ED pr\u00E1va a povinnosti mezi provozovatelem platformy Woker a u\u017Eivateli slu\u017Eby. Provozovatelem je fyzick\u00E1 osoba podnikaj\u00EDc\u00ED ve \u0160v\u00FDcarsku. Pou\u017E\u00EDv\u00E1n\u00EDm platformy Woker na adrese gowoker.com u\u017Eivatel souhlas\u00ED s t\u011Bmito podm\u00EDnkami." },
    ...
    { title: "4. Platebn\u00ED podm\u00EDnky", text: "Woker nab\u00EDz\u00ED p\u0159edplatn\u00E9 v cenov\u00FDch pl\u00E1nech: m\u011Bs\u00ED\u010Dn\u00ED (CHF 9/m\u011Bs\u00EDc) a \u010Dtvrtletn\u00ED (CHF 19 / 3 m\u011Bs\u00EDce). Prvn\u00EDch 7 dn\u00ED je zdarma, platba prob\u011Bhne a\u017E po skon\u010Den\u00ED zku\u0161ebn\u00ED doby. Platby jsou zpracov\u00E1ny prost\u0159ednictv\u00EDm slu\u017Eby Stripe. P\u0159edplatn\u00E9 se automaticky obnovuje, pokud nen\u00ED zru\u0161eno p\u0159ed koncem aktu\u00E1ln\u00EDho obdob\u00ED. Zru\u0161en\u00ED je mo\u017En\u00E9 kdykoliv v nastaven\u00ED \u00FA\u010Dtu." },
    { title: "5. Pr\u00E1vo na odstoupen\u00ED", text: "V souladu s evropskou legislativou m\u00E1 u\u017Eivatel pr\u00E1vo odstoupit od smlouvy do 14 dn\u016F od zakoupen\u00ED p\u0159edplatn\u00E9ho bez ud\u00E1n\u00ED d\u016Fvodu. \u017D\u00E1dost o vr\u00E1cen\u00ED pen\u011Bz je mo\u017En\u00E9 zaslat na e-mail info@gowoker.com. Vr\u00E1cen\u00ED bude provedeno stejn\u00FDm zp\u016Fsobem platby do 14 pracovn\u00EDch dn\u016F." },
    ...
    { title: "9. Kontakt", text: "V p\u0159\u00EDpad\u011B dotaz\u016F n\u00E1s kontaktujte na e-mailu info@gowoker.com." },
  ];
  return (
    <main style={{ minHeight: "100vh", background: "#0a0a12", fontFamily: "'Plus Jakarta Sans', sans-serif", padding: "60px 20px", position: "relative" }}>
      <div style={{ position: "fixed", width: "500px", height: "500px", borderRadius: "50%", filter: "blur(140px)", pointerEvents: "none", zIndex: 0, opacity: 0.15, top: "-200px", right: "-200px", background: "radial-gradient(circle, rgba(251,146,60,0.2), transparent 70%)" }} />
