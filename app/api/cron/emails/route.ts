  ...
  const emails: Record<number, { subject: string; html: string }> = {
    ...
    1: {
      ...
      html: wrap(name, `
        ...
        <p>Klíč? <strong style="color:#fb923c;">Přímý kontakt na zaměstnavatele.</strong> Žádný prostředník. Žádné poplatky. Prostě jsem napsal email, zavolal a za 2 týdny měl smlouvu.</p>
        <p>Proto jsem vytvořil Woker — abych tohle umožnil každému.</p>
        <div style="margin:24px 0;padding:16px;background:rgba(251,146,60,0.08);border-radius:10px;border-left:3px solid #fb923c;">
          <p style="margin:0;color:#ccccdd;font-size:14px;"><strong style="color:#fb923c;">Tip:</strong> Už jste si přečetl/a průvodce? Začněte krokem 1 — pracovní povolení. Je to jednodušší, než si myslíte.</p>
        </div>`)
    },
    ...
    3: {
      ...
      html: wrap(name, `
        ...
        <p style="margin-top:20px;">Chcete se přidat? S <strong style="color:#fb923c;">1 007+ kontakty</strong> je to jednodušší, než si myslíte.</p>
        <div style="text-align:center;margin:24px 0;">
          <a href="https://gowoker.com/#cenik" style="display:inline-block;background:#fb923c;color:#0a0a12;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:bold;">Prozkoumat Woker Premium →</a>
        </div>`)
    },
    ...
    4: {
      ...
      html: wrap(name, `
        ...
        <div style="margin:20px 0;padding:24px;background:linear-gradient(135deg,rgba(251,146,60,0.08),rgba(251,146,60,0.02));border:1px solid rgba(251,146,60,0.15);border-radius:12px;">
          <p style="color:#fb923c;font-weight:bold;font-size:18px;margin:0 0 12px;">Woker Premium — €9,99/měsíc</p>
        ...
        <div style="text-align:center;margin:24px 0;">
          <a href="https://gowoker.com/#cenik" style="display:inline-block;background:#fb923c;color:#0a0a12;padding:16px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px;">Začít s Woker Premium →</a>
        </div>
    ...
    5: {
      ...
      html: wrap(name, `
        ...
        <div style="text-align:center;margin:24px 0;">
          <a href="https://gowoker.com/#cenik" style="display:inline-block;background:#fb923c;color:#0a0a12;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:bold;">Začít s Woker Premium →</a>
        </div>
