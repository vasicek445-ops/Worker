...
<div style="max-width:560px;margin:0 auto;padding:40px 20px;">
  ...
  <div style="background:#111122;border-radius:16px;padding:32px 28px;border:1px solid rgba(255,255,255,0.06);">
    ...
    <div style="text-align:center;margin:24px 0;">
      <a href="https://gowoker.com/downloads/5-kroku-prace-svycarsko.pdf"
         style="display:inline-block;background:#fb923c;color:#0a0a12;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:16px;">
  ...
  <div style="margin-top:24px;padding:20px 24px;background:#111122;border-radius:12px;border-left:3px solid #fb923c;">
    <p style="color:#ccccdd;font-size:14px;line-height:1.6;margin:0;">
      <strong style="color:#fb923c;">P.S.</strong> Pokud chcete přímý přístup k
      <strong style="color:#f0f0f5;">1 007+ kontaktům na švýcarské zaměstnavatele</strong>,
      podívejte se na <a href="https://gowoker.com/#cenik" style="color:#fb923c;">Woker Premium</a>.
  ...
  <div style="text-align:center;margin-top:32px;padding-top:20px;border-top:1px solid #222244;">
    <p style="color:#8888aa;font-size:12px;margin:0;">
      Václav z Wokeru | <a href="https://gowoker.com" style="color:#fb923c;text-decoration:none;">gowoker.com</a>
    </p>
