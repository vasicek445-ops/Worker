  ...
  <div style="background:#111122;border-radius:16px;padding:28px 24px;border:1px solid rgba(255,255,255,0.06);color:#ccccdd;font-size:15px;line-height:1.7;">
    ...
    <div style="margin:20px 0;">
      <div style="display:flex;gap:12px;margin-bottom:14px;">
        <div style="min-width:32px;height:32px;background:rgba(251,146,60,0.1);border-radius:50%;text-align:center;line-height:32px;font-size:14px;">1</div>
        <div>
      ...
      <div style="display:flex;gap:12px;margin-bottom:14px;">
        <div style="min-width:32px;height:32px;background:rgba(251,146,60,0.1);border-radius:50%;text-align:center;line-height:32px;font-size:14px;">2</div>
        <div>
      ...
      <div style="display:flex;gap:12px;margin-bottom:14px;">
        <div style="min-width:32px;height:32px;background:rgba(251,146,60,0.1);border-radius:50%;text-align:center;line-height:32px;font-size:14px;">3</div>
        <div>
    ...
    <div style="text-align:center;margin:24px 0;">
      <a href="https://www.gowoker.com/dashboard" style="display:inline-block;background:#fb923c;color:#0a0a12;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:bold;font-size:15px;">Otevřít Woker →</a>
    </div>
